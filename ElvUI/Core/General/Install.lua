...
function E:LayoutAnniversary()
	...
	E.db.actionbar.stanceBar.visibility = '[vehicleui][pet] hide; show'
	...
	E.db.databars.petExperience.height = 12
	E.db.databars.petExperience.width = 316
	...
	E.db.unitframe.units.arena.health.text_format = '[healthcolor][health:percent]'
	...
	E.db.unitframe.units.boss.health.text_format = '[healthcolor][health:percent]'
	...
	E.db.unitframe.units.player.health.text_format = '[healthcolor][health:percent]'
	...
	E.db.unitframe.units.raid.height = 39
	E.db.unitframe.units.raid.horizontalSpacing = 4
	...
	E.db.unitframe.units.raid.visibility = '[@raid11,exists] show;hide'
	E.db.unitframe.units.raid.width = 83
	E.db.unitframe.units.raid.health.text_format = '[healthcolor][perhp]'
	E.db.unitframe.units.raid40.growthDirection = 'RIGHT_UP'
	E.db.unitframe.units.raid40.height = 39
	E.db.unitframe.units.raid40.horizontalSpacing = 4
	...
	E.db.unitframe.units.target.health.text_format = '[healthcolor][health:percent]'
