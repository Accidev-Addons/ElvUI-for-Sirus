...
S:AddCallback("Skin_LFD", function()
	...
	LFDQueueFrameRoleButtonTank.checkButton:OffsetFrameLevel(2, LFDQueueFrameRoleButtonTank.checkButton)
	S:HandleCheckBox(LFDQueueFrameRoleButtonHealer.checkButton)
	LFDQueueFrameRoleButtonHealer.checkButton:OffsetFrameLevel(2, LFDQueueFrameRoleButtonHealer.checkButton)
	S:HandleCheckBox(LFDQueueFrameRoleButtonDPS.checkButton)
	LFDQueueFrameRoleButtonDPS.checkButton:OffsetFrameLevel(2, LFDQueueFrameRoleButtonDPS.checkButton)
	...
	LFDQueueFrameCooldownFrame:HookScript("OnShow", function(self)
		self:OffsetFrameLevel(5, self:GetParent())
	end)
	...
	LFDDungeonReadyDialog.backdrop:OffsetFrameLevel(nil, LFDDungeonReadyDialog)
