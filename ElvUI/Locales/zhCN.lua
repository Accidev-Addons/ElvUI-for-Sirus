...
L["System"] = "系统信息"
L["Talent Specialization"] = "天赋/拾取专精"
...
L["You can always change fonts and colors of any element of ElvUI from the in-game configuration."] = "你可以在游戏内的设置中更改ElvUI的字体、颜色等设置."
