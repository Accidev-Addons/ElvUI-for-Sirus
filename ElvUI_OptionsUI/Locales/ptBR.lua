...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "Adicionar uma aura ao filtro. Números de identificação (IDs) podem ser adquiridos usando o tooltip para encontrar o ID correto."
...
L["Blizzard"] = true
L["Blizzard Improvements"] = "Melhorias do Blizzard"
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "Mudar a escala do Menu do Jogo que aparece quando você aperta ESC."
...
L["Hide Quest Progress and Error Text"] = "Esconder o Progresso da Missão e o Texto de Erro"
...
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] = "Esconde o texto amarelo de progresso das missões e o texto de erro vermelho do topo da tela quando em combate."
L["High"] = "Alto"
...
L["Nameplate Scaling"] = "Dimensionamento de placas de nome"
...
L["Say"] = "Dizer"
L["Scale"] = "Escala"
L["Scale Nameplates to UI Scale."] = "Ajusta as placas de nome à escala da IU."
