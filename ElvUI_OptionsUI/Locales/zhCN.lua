...
L["Adjust the scale of the minimap and also the pins. Eg: Quests, Resource nodes, Group members"] = "调整小地图和图钉的缩放。例如：任务、资源点、小队成员"
...
L["Growth X-Direction"] = "X方向增长"
L["Growth Y-Direction"] = "Y方向增长"
L["Growth"] = "增长"
L["Guardians"] = "护卫"
L["Guide Frame"] = "指南框架"
L["Guide:"] = "指南:"
...
L["Replaces the StatusBar texture setting on Unitframes and Nameplates with the primary texture."] = "替换单位框架和姓名版上的状态栏文本设置主要材质"
...
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "重置姓名版参数（CVars）到ElvUI推荐默认值"
...
L["TEXTURE_EXAMPLE"] = [=[若要设置聊天框背景, 请你指定位于WoW目录下的「Textures」文件夹中的材质文件名.
