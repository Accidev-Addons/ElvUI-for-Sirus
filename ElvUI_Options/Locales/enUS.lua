...
L["Buff consolidation is toggled by the 'Consolidate Buffs' checkbox in the game's Interface options."] = true
...
L["Consolidate Direction"] = true
L["Consolidate Icon Size"] = true
L["Consolidate Size"] = true
L["Content"] = true
L["Contribution"] = true
...
L["Position of the damage absorb bar on the health bar."] = true
...
L["HeadHunting Wanted"] = true
L["HEADHUNTING_WANTED_DESC"] = "Display a model over the target's health bar while the target is wanted by the HeadHunting system."
L["Headers"] = true
L["Heal Absorbs"] = true
...
L["Max Overflow"] = true
L["Max Wraps"] = true
L["Maximum amount of consolidated buffs shown in the popup."] = true
...
L["Set the size of the buff consolidation button."] = true
L["Set the size of the icons in the consolidated buffs popup."] = true
...
L["Legacy Collection"] = true
L["Loot Case Preview"] = true
L["Customizations"] = true
L["Roulette"] = true
L["Toy Collection"] = true
L["Wardrobe"] = true
L["Stack Auras"] = true
...
L["The direction the consolidated buffs will grow."] = true
...
L["Show seconds on the time display."] = true
L["Shown Bags"] = true
...
L["|cFF666666[1/5]|r White name text, missing hp red"] = true
L["|cFF666666[2/5]|r Class color name text, missing hp red"] = true
L["|cFF666666[3/5]|r Class color name text, missing hp based on hex code"] = true
L["|cFF666666[4/5]|r Name text based on hex code, missing hp red"] = true
L["|cFF666666[5/5]|r Name text based on hex code, missing hp class color"] = true
----------------------------------

L["Premium"] = true
L["VIP"] = true
L["Faction"] = true
L["Add an item or search syntax to the deconstruct blacklist."] = true
L["Add an item or search syntax to the lockbox blacklist."] = true
L["Deconstruct Blacklist"] = true
L["Deconstruct Blacklist (Global)"] = true
L["Deconstruct Blacklist (Profile)"] = true
L["Lockbox Blacklist"] = true
L["Lockbox Blacklist (Global)"] = true
L["Lockbox Blacklist (Profile)"] = true
