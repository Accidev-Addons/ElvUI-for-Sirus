...
L["Allows BigWigs to rename specific encounter spells on your castbar to something better to understand.\nExample: 'Impaling Eruption' becomes 'Frontal' and 'Twilight Massacre' becomes 'Dash'."] = "Позволяет BigWigs переименовывать заклинания боссов на полосе заклинаний в более понятные.\nПример: «Impaling Eruption» станет «Фронтальная», а «Twilight Massacre» — «Рывок»."
L["Add Aura ID"] = "Добавить ID ауры"
L["Remove Aura"] = "Удалить ауру"
L["Select Aura"] = "Выбрать ауру"
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "Добавляет ауру в фильтр. ID ауры можно узнать из всплывающей подсказки."
...
L["Bottom"] = "Внизу"
L["Buff consolidation is toggled by the 'Consolidate Buffs' checkbox in the game's Interface options."] = "Объединение баффов включается галкой \"Объединять положительные эффекты\" в стандартных настройках интерфейса."
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "Изменяет масштаб игрового меню, которое открывается по ESC."
...
L["Consolidate Buffs"] = "Объединять баффы"
L["Consolidate Direction"] = "Направление роста объединённых"
L["Consolidate Icon Size"] = "Размер кнопки объединения"
L["Consolidate Size"] = "Размер объединённых"
...
L["DEBUG_DESC"] = "Отключить все аддоны (включая плагины), кроме ElvUI. В течение этой же сессии можно нажать повторно, чтобы включить их обратно."
...
L["Dummy Control"] = "Управление манекеном"
...
L["Position of the damage absorb bar on the health bar."] = "Расположение полосы поглощения урона на полосе здоровья."
L["Quest Progress and Error Text"] = "Текст заданий и ошибок"
...
L["HeadHunting Wanted"] = "Охота за головами"
L["HEADHUNTING_WANTED_DESC"] = "Показывать модель поверх полосы здоровья цели, пока цель находится в розыске системы «Охота за головами»."
L["Headers"] = "Заголовки"
...
L["Hide Quest Progress and Error Text"] = "Скрывать текст заданий и ошибок"
...
L["Hide Texture"] = "Прятать текстуру"
...
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] = "Скрывает жёлтый текст прогресса заданий и красный текст ошибок в верхней части экрана во время боя."
L["High"] = "Верхний"
...
L["Item Browser"] = "Обозреватель предметов"
...
L["Max Consolidated"] = "Максимум объединённых"
...
L["Maximum amount of consolidated buffs shown in the popup."] = "Максимальное количество объединённых баффов, показываемых во всплывающем окне."
...
L["Set the size of the buff consolidation button."] = "Задает размер кнопки, в которой собираются объединённые баффы."
L["Set the size of the icons in the consolidated buffs popup."] = "Задает размер иконок объединённых баффов во всплывающем окне."
...
L["Stable"] = "Стойла"
L["Store"] = "Магазин"
L["Toasts"] = "Уведомления"
L["Battle Pass"] = "Боевой пропуск"
L["Collections"] = "Коллекции"
L["Hardcore"] = "Хардкор"
L["Headhunting"] = "Охота за головами"
L["Encounter Journal"] = "Приключения"
L["Legacy Collection"] = "Наследие"
L["Loot Case Preview"] = "Предпросмотр кейсов"
L["Customizations"] = "Кастомизация"
L["Roulette"] = "Рулетка тысячелетия"
L["Toy Collection"] = "Коллекция игрушек"
L["Wardrobe"] = "Трансмогрификация"
...
L["The direction the consolidated buffs will grow."] = "Направление, в котором будут расти объединённые баффы."
...
L["Value"] = "Значение"
L["Vehicle Exit"] = "Покинуть транспорт"
...
L["Abbreviate Enchants"] = "Сокращать зачарования"
...
L["Arrow X-Offset"] = "Смещение стрелки по X"
L["Arrow Y-Offset"] = "Смещение стрелки по Y"
L["Assist Target"] = "Цели помощников"
L["BG Score"] = "Таблица ПБ"
L["BLOCK"] = "Блок"
L["Blacklist Modifier"] = "Модификатор черного списка"
L["Blizzard Cooldown"] = "Восстановление Blizzard"
...
L["Color your tag or text by replacing the XXXXXX with a hex color code. (Name tag as red text. Ex: ||cffFF0000[name]||r)"] = "Раскрасьте тег или текст, заменив XXXXXX на HEX-код цвета. (Имя красным. Пример: ||cffFF0000[name]||r)"
L["Combo Point"] = "Очко серии"
L["Cooldown Orientation"] = "Ориентация текста восстановлению"
L["Copy Settings From"] = "Скопировать из"
L["Count"] = "Кол-во"
L["Current - Max | Percent"] = "Текущее - Максимальное | Процент"
L["Custom Class Colors"] = "Свои цвета классов"
L["DISABLE"] = "Отключить"
L["Debug"] = "Отладка"
L["Deficit"] = "Дефицит"
...
L["Display Tooltip on Raid Markers."] = "Показывать подсказку у рейдовых меток."
...
L["Dont scale by Font Size as base."] = "Не масштабировать, отталкиваясь от базового размера шрифта."
...
L["Flyout Height"] = "Высота выдвижной панели"
L["Flyout Options"] = "Выдвижная панель"
L["Flyout Size"] = "Размер выдвижной панели"
L["Flyout Spacing"] = "Отступ выдвижной панели"
L["Flyout Width"] = "Ширина выдвижной панели"
L["Font Size as defined by Blizzard."] = "Размер шрифта, заданный Blizzard."
...
L["Health Length"] = "Длительность среза здоровья"
...
L["Master Version"] = "Версия master"
...
L["Modulating Blend"] = "Модулирующее смешивание"
L["NAMEPLATE_FRAMELEVEL_DESC"] = "Если задать 1, все индикаторы, попавшие под этот фильтр стиля, будут выше всех остальных.\n\nЕсли в другом фильтре стиля задать 2, его индикаторы окажутся выше индикаторов с уровнем 1 и всех остальных, и так далее.\n\nВНИМАНИЕ: это не решает проблему кликов и наведения на перекрывающиеся индикаторы — уровень кликабельной области индикаторов изменить нельзя."
...
L["Objective Text"] = "Текст целей задания"
L["Offset position for text."] = "Отступ для текста."
L["Only Equipped"] = "Только надетое"
...
L["PVP Sub Zone"] = "PvP: подзона"
L["PVP Zone Text"] = "PvP: текст зоны"
...
L["Quest Small"] = "Задания (мелкий шрифт)"
...
L["Share Global"] = "Передать глобальный"
L["Share Private"] = "Передать приватный"
L["Share Profile"] = "Передать профиль"
L["Shortcut to 'Filters' section of the config."] = "Ярлык для секции фильтров в настройках."
L["Show Enchants"] = "Показывать зачарования"
L["Show Gems"] = "Показывать самоцветы"
L["Show ItemLevel"] = "Показывать уровень предметов"
L["Show seconds on the time display."] = "Показывать секунды в отображении времени."
L["Shown Bags"] = "Отображаемые сумки"
L["Size of the indicator icon."] = "Размер иконки индикатора."
L["Sort Spinner"] = "Индикатор сортировки"
L["Start Animation"] = "Анимация запуска"
...
L["World Sub Zone"] = "Мир: подзона"
L["World Zone Text"] = "Мир: текст зоны"
L["You do not need to use 'Is Casting Anything' or 'Is Channeling Anything' for these spells to trigger."] = "Вам не нужно использовать \"Произносит заклинание\" или \"Поддерживает заклинание\" для срабатывания этих заклинаний."
...
L["|cFF666666[1/5]|r White name text, missing hp red"] = "|cFF666666[1/5]|r Белое имя, недостающее здоровье красным"
L["|cFF666666[2/5]|r Class color name text, missing hp red"] = "|cFF666666[2/5]|r Имя цветом класса, недостающее здоровье красным"
L["|cFF666666[3/5]|r Class color name text, missing hp based on hex code"] = "|cFF666666[3/5]|r Имя цветом класса, недостающее здоровье по HEX-коду"
L["|cFF666666[4/5]|r Name text based on hex code, missing hp red"] = "|cFF666666[4/5]|r Имя по HEX-коду, недостающее здоровье красным"
L["|cFF666666[5/5]|r Name text based on hex code, missing hp class color"] = "|cFF666666[5/5]|r Имя по HEX-коду, недостающее здоровье цветом класса"
----------------------------------

L["Premium"] = "Премиум"
L["VIP"] = "VIP"
L["Faction"] = "Фракция"
L["Add an item or search syntax to the deconstruct blacklist."] = "Добавить предмет или поисковый запрос в черный список распыления."
L["Add an item or search syntax to the lockbox blacklist."] = "Добавить предмет или поисковый запрос в черный список ларей."
L["Deconstruct Blacklist"] = "Черный список распыления"
L["Deconstruct Blacklist (Global)"] = "ЧС распыления (Общий)"
L["Deconstruct Blacklist (Profile)"] = "ЧС распыления (Профиль)"
L["Lockbox Blacklist"] = "Черный список ларей"
L["Lockbox Blacklist (Global)"] = "ЧС ларей (Общий)"
L["Lockbox Blacklist (Profile)"] = "ЧС ларей (Профиль)"
L["Tabs"] = "Вкладки"
L["Single Bag"] = "Одна сумка"
L["Compact"] = "Компактный"
L["Show the reagent bank on its own tab or as an extra bag inside the bank."] = "Показывать банк материалов отдельной вкладкой или дополнительной сумкой внутри банка."
L["Collapse the reagent bank into a single slot showing the number of free slots."] = "Свернуть банк материалов в один слот с числом свободных ячеек."
